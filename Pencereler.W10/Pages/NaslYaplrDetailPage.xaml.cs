//---------------------------------------------------------------------------
//
// <copyright file="NaslYaplrDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class NaslYaplrDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public NaslYaplrDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new NaslYaplrSection());
