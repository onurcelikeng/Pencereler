//---------------------------------------------------------------------------
//
// <copyright file="RoportajlarDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class RoportajlarDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public RoportajlarDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new RoportajlarSection());
