//---------------------------------------------------------------------------
//
// <copyright file="KutuAclmDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class KutuAclmDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public KutuAclmDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new KutuAclmSection());
